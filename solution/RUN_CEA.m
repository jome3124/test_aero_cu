function[SM_results1,SM_results3] = RUN_CEA(Pc_en, AR_sup)
    ...
    SM_inputs.fu1      = 'AL(cr)';                 %primary oxidizer
    SM_inputs.fu1T     = 536;                    %primary ox temp (R)

    SM_inputs.fu2      = 'C4H6,butadiene';                 %primary fuel
    SM_inputs.fu2T     = 536;                    %primary fuel temp (R)
    
    SM_inputs.ox1wt    = 66;                      %primary oxidizer weight (by mass) in total 
    SM_inputs.fu1wt    = 16;                        % secondary oxidizer weight (by mass) in total
    SM_inputs.fu2wt    = 18;                        % primary fuel weight (by mass) in total
