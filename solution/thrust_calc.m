function [ThSM_en, Cs,m_dot] = thrust_calc(Pa, Pc, Ae, rho_p, burn_rate, A_burn, AR_sup, delta_Vol)
    ...
    m_dot = (rho_p - rho_g) * burn_rate * A_burn - delta_Vol*rho_g; % [kg/s] propellant mass flow rate

    %% THRUST CALCULATION
    Ve = alpha*Mach; % nozzle exit velocity [m/s]

    ThSM = (m_dot * Ve + (Pe - Pa) * Ae); % [N]
    ThSM_en = ThSM * 0.224809;